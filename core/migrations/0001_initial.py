# Generated by Django 2.2.8 on 2020-02-11 08:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('Fruits &Vegtables', 'Fruits &Vegtables'), ('Drinks', 'Drinks'), ('Drinks', 'Beverages'), ('Canned & Packaged food', 'Canned & Packaged food'), ('Grains, Rice and Dried Beans', 'Grains, Rice and Dried Beans'), ('Grains, Rice and Dried Beans', 'Herbs, Spices & Seasoning'), ('Laundry & Household Cleaning', 'Laundry & Household Cleaning'), ('Biscuits and Confectionaries', 'Biscuits and Confectionaries'), ('Others', 'Others')], max_length=30)),
                ('label', models.CharField(choices=[('New', 'primary'), ('Best-selling', 'secondary'), ('Out of stock', 'danger')], max_length=20)),
